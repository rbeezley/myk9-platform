...
test('Debug show add button visibility', async ({ page }) => {
  ...
  await page.screenshot({
    path: 'd:/AI-Projects/myK9Show-Windsurf/screenshots/debug-browse-shows.png',
  });
  ...
  const showCard = page
    .locator('[class*="show"], [data-testid*="show"], a[href*="/shows/"]')
    .first();
  ...
  if (await showCard.isVisible({ timeout: 5000 })) {
    ...
    await page.screenshot({
      path: 'd:/AI-Projects/myK9Show-Windsurf/screenshots/debug-show-details.png',
    });
    ...
    await page.waitForTimeout(3000);
    await page.screenshot({
      path: 'd:/AI-Projects/myK9Show-Windsurf/screenshots/debug-direct-navigation.png',
    });
  ...
  await page.screenshot({
    path: 'd:/AI-Projects/myK9Show-Windsurf/screenshots/debug-login-page.png',
  });
  ...
  if (await emailInput.isVisible({ timeout: 5000 })) {
    ...
    await page.screenshot({
      path: 'd:/AI-Projects/myK9Show-Windsurf/screenshots/debug-after-login.png',
    });
    ...
    await page.screenshot({
      path: 'd:/AI-Projects/myK9Show-Windsurf/screenshots/debug-authenticated-show-details.png',
    });
  ...
  await page.screenshot({
    path: 'd:/AI-Projects/myK9Show-Windsurf/screenshots/debug-final-state.png',
  });
