...
| S8.3 | Produce show-level financial totals for the club.                  | Partially covered | Use `secretary-show-financial-totals` evidence: Financial Report now separates entry/payment status and prints gross, discounts, waived, collected, refunded, outstanding, net retained, payment-method, and trial breakdowns. | Run representative print/PDF and club reconciliation rehearsal before marking launch-verified. |
