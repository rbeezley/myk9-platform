...
> **Status:** Complete — shipped in [#1294](https://github.com/rbeezley/myk9-platform/pull/1294) on 2026-07-12.

**Date:** 2026-05-22
> Tracked in openspec change: `class-status-auto-derivation` (archived after main-spec sync). This doc remains the design/decision record. The shipped change refined the existing server-side derivation with corrected completeness math, a durable override marker, late-entry reopening, client reconciliation, and show-map attention.
...
**Companion plan:** [`plan-show-map-workbench-collapse.md`](plan-show-map-workbench-collapse.md) (Option B — archived; link verified 2026-07-12). Phase B2b includes a future-proofing note for this work.
