...
### 15. Review entries and exception queues

**Outcome:** Secretary approves, rejects, waitlists, or reviews move-up/pull exceptions for entries in one canonical management surface; records mail-in payment.
...
**Docs target:** Secretary Guide § Entry Management, KB: `entry-status.md`, `approve-entries.md`
...
### 21. Ringside scoring and paper-scoring fallback
