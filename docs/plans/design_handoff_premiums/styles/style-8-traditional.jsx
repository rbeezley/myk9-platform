    ...
    <div className="premium-doc s8">
      ...
      <div className="sheet">
        ...
        <div className="s8-page">
          <div className="s8-cover">
            ...
            <h1 className="s8-title">
              Spring <em>Scent Work</em>
              <br />
              Trial
            </h1>
            ...
            <div className="s8-seal">
              <div className="icon">
                B<span style={{ fontStyle: 'normal' }}>·</span>K
                <span style={{ fontStyle: 'normal' }}>·</span>C
              </div>
          ...
          <div className="s8-cover-foot">
            Entries close on the third day of June, Anno {2026}, at the hour of eight in the
            evening.
          </div>
        </div>
      </div>
      ...
      <div className="sheet">
        ...
        <div className="s8-page">
          ...
          <p className="s8-prose" style={{ margin: '0 32px 18px' }}>
            {RT.welcomeFromChair}
          </p>
          <p
            style={{
          ...
          >
            — {RT.trialCommittee[0].name}, {RT.trialCommittee[0].role}
          </p>

          <div className="s8-rule-orn gold">
            <span className="line"></span>
            <span className="di">✦</span>
            <span className="line"></span>
          </div>
      ...
      <div className="sheet">
        ...
        <div className="s8-page">
          ...
          <h2 className="s8-h2" style={{ marginTop: 18 }}>
          ...
          <table className="s8-table">
            ...
            <tbody>
              {RT.classes.map((c, i) => (
                <tr key={i}>
                  <td className="em" style={{ fontSize: 16 }}>
                    {c.level}
                  </td>
      ...
      <div className="sheet">
        ...
        <div className="s8-page">
          ...
          <p className="s8-prose" style={{ margin: '0 32px 12px' }}>
            {RT.showHoursNarrative}
          </p>
          ...
          <table className="s8-table">
            <tbody>
              {RT.schedule.map((s, i) => (
                <tr key={i}>
                  <td className="em" style={{ width: 120 }}>
                    {s.time}
                  </td>
                  <td>{s.item}</td>
                </tr>
          ...
          <h2 className="s8-h2" style={{ marginTop: 20 }}>
            Of the Entry &amp; Its Fee
          </h2>

          <div className="s8-fees">
            <div className="s8-fee">
              <div className="n">${RT.fees.firstEntry}</div>
              <div className="l">first entry</div>
            </div>
            <div className="s8-fee">
              <div className="n">${RT.fees.additional}</div>
              <div className="l">each additional</div>
            </div>
            <div className="s8-fee">
              <div className="n">${RT.fees.junior}</div>
              <div className="l">junior handler</div>
            </div>
          </div>

          <p className="s8-prose">
            Entries shall be received <em>by post, by electronic mail, or online</em>, and must be
            in the hands of the Trial Secretary no later than {RT.closingTime} on {RT.closingDate}.
          </p>
      ...
      <div className="sheet">
        ...
        <div className="s8-page">
          ...
          <h2 className="s8-h2" style={{ marginTop: 18 }}>
            Hospitality &amp; Veterinarian
          </h2>
          <p className="s8-prose">{RT.hospitalityNotes}</p>
          <p className="s8-prose">
            <em>On call:</em> {RT.vetClinic.name}, {RT.vetClinic.address} · {RT.vetClinic.phone}
          </p>
          ...
          <div className="s8-sig-row">
            <div className="sig">
              {RT.officers.find(o => o.role === 'President').name}, President
            </div>
