...
window.PREMIUM_SKINNY = {
  ...
  totalEntries: 1,
  judges: [{ name: 'Robin Stansell', panel: 'All Breeds' }],
  events: [
...
window.PREMIUM_RICH = {
  ...
  fees: {
    ...
    lateFee: 10,
    refundPolicy:
      'Refunds (less $5 processing) issued for written withdrawals received before closing.',
  },
  ...
  judges: [
    {
      ...
      city: 'Austin, TX',
      trials: 'Trials 1, 3, 5',
      element: 'Containers, Interiors, Buried',
    },
    {
      name: 'Marcus Whitfield',
      city: 'Boulder, CO',
      trials: 'Trials 2, 4, 6',
      element: 'Exteriors, Vehicles, Handler Discrimination',
    },
  ],
  ...
  classes: [
    ...
    },
    {
      ...
      elements: ['Containers', 'Interiors', 'Exteriors', 'Buried'],
      duration: '2 min',
      hides: '1–2 per element',
    },
    {
      level: 'Excellent',
      elements: ['Containers', 'Interiors', 'Exteriors', 'Buried'],
      duration: '2:30',
      hides: '2–3 per element',
    },
    {
      level: 'Master',
      elements: ['All four + Handler Disc.', 'Detective'],
      duration: '3 min',
      hides: '3–5 per element',
    },
  ],
  ...
  trialCommittee: [
    ...
    {
      role: 'Trial Secretary',
      name: 'James Nakamura',
      contact: 'secretary@bckc.org · (210) 555-0142',
    },
  ...
  hospitalityNotes:
    'Lunch and refreshments provided on site Friday through Sunday. Coffee and breakfast tacos at check-in.',
  awardsDescription:
    "Hand-tied rosettes for first through fourth in every class, qualifying ribbons for all qualifying scores, an engraved bowl for High in Trial each day, and a silver platter for High Combined Master at weekend's end.",
  additionalNotes:
    'Soft-sided crates only in the crating hall. No flexi-leads on the trial floor. Please pick up after your dog.',

  // Generated narratives (editable)
  showHoursNarrative:
    'Doors open at 7:00 AM each day with check-in immediately following. Briefings begin at 7:45 AM and the first trial begins at 8:30 AM. An approximate end time of 5:30 PM is targeted, dependent on entry count.',
  trialInformationNarrative:
    'The June 2026 AKC event features six full Scent Work trials over three days at the Live Oak Civic Center. Trials cover all four elements — Containers, Interiors, Exteriors, and Buried — across Novice, Advanced, Excellent, and Master class levels, providing opportunities for dogs at every stage of their scent work career.',
  welcomeFromChair:
    "For seventy-nine years our club has put on shows that exhibitors look forward to. This spring we return with three days of scent work — a discipline built on partnership, patience, and the impossibly good nose of a willing dog. We hope you'll join us at Live Oak.",
  aboutTheClub:
    'Bexar County Kennel Club was founded in 1947 and has held licensed AKC events in the San Antonio area continuously since. The club hosts conformation, obedience, rally, and scent work events throughout the year, and is proud to be a member club of the American Kennel Club.',
  venueDescription:
    'The Live Oak Civic Center is an indoor, climate-controlled facility with sealed concrete flooring throughout. Crating is in the adjacent ballroom; parking is plentiful and free. The site is ten minutes from the airport and walkable to several hotels.',
};
