...
- [ ] **1. Code-Quality Audit** — remove static debt first; every later step audits or builds on the post-cleanup surfaces. Plan: [`docs/plan-code-quality-audit.md`](docs/plan-code-quality-audit.md). _In progress — Wave A, Wave B type-file unification, P1 launch gates, email parity, and read-shape parity are implemented._
