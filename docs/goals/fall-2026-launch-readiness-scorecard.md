...
| Exhibitor golden path | An exhibitor can find a show, enter a dog, pay, receive updates, understand show-day status, and view results. | Browser walkthrough; payment/entry test data; real-user test. | Yellow — Phase 6 re-walk 2026-06-15 ([`plan-ux-journey-phase6.md`](../plan-ux-journey-phase6.md), [`SUMMARY.md`](../audits/2026-06-ux-journeys/SUMMARY.md)): find→enter→pay walked as `exhibitor1` (P1-01 fixed via class seed; [PR #767](https://github.com/rbeezley/myk9-platform/pull/767)). Green pending confirmation/results leg + `UX-P2-04-EXP` (styled-landing class fit). |
