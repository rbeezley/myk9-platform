      ...
      <div className="space-y-8">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="space-y-2">
            <h1 className="text-4xl font-bold tracking-tight">Judge Dashboard</h1>
            <p className="text-muted-foreground text-lg">Manage your judging assignments</p>
          </div>
          <Button
            variant="outline"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <Card className="bg-card/95 backdrop-blur-sm border-border/50 shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-0.5 hover:border-primary/20">
            <CardHeader>
              ...
              <CardDescription>
                Manage entries and check-in status within your classes
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button
