...
3. Apply `supabase/seed-demo.sql`, then the opt-in `supabase/seed-load-fixture.sql` (the MYK9-109 load fixture, split out of the demo seed by MYK9-558), and verify the known show, classes, judge assignments, role grants and the 517-entry demo show.
...
- [Run 30306515857](https://github.com/rbeezley/myk9-platform/actions/runs/30306515857) was the first complete infrastructure pass at commit `c4ba26c8b`: pass one completed with 51 passed and 2 skipped in 2.9 minutes, reset/reseed succeeded, and pass two completed with 51 passed and 2 skipped in 3.0 minutes. Later strengthening made the secretary and offline-scoring journeys prove real isolated RPC/database persistence, so this run was superseded as final evidence.
- [Run 30316092599](https://github.com/rbeezley/myk9-platform/actions/runs/30316092599) at commit `7718ec187` was the first complete pass with both production reliability fixes: the replication upload follow-up drain and the derived-status placement no-op guard. Pass one completed with 51 passed and 2 skipped in 2.9 minutes, reset/reseed succeeded, and pass two completed with 51 passed and 2 skipped in 3.0 minutes.
- [Run 30316750529](https://github.com/rbeezley/myk9-platform/actions/runs/30316750529) is the acceptance run at exact executable commit `a11858076` after independent-review refinements. Pass one completed with 51 passed and 2 skipped in 2.9 minutes, reset/reseed succeeded, and pass two completed with 51 passed and 2 skipped in 3.0 minutes. Both passes used one worker, zero retries, and fail-on-flaky-tests.

Successful dispatch: [run 30316750529](https://github.com/rbeezley/myk9-platform/actions/runs/30316750529).
