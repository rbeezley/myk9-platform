...
/**
 * Dispatch a health item add via the async mutation path and return the
 * mutation promise. Used both for single-item creation (awaited so the
 * dialog can preserve entered values and stay open on failure) and for
