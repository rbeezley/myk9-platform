...
import { BODY, INK, INK_SOFT, MONO, MUTE, PAPER_WARM, RED, SectionHeader } from './pdfPrimitives';
...
export function AgreementSection({ agreementText }: { agreementText: string }) {
  ...
  return (
    <View>
      <SectionHeader number="05" title="Agreement & signature" kicker="read before signing" />
