...
| [plan-permissions-overview-roles-console.md](plan-permissions-overview-roles-console.md)                         | Active    | Permissions Overview — roles-first console (Option B redesign, 4 phases)     |
