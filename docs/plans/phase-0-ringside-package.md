...
| **G** | Move remaining dialogs + ringside hooks | low | Mop-up. Some dialogs may already be in `@myk9/ringside` by this point if E2 had to pull them transitively; G covers whatever's left. |
