...
| S-16    | Entry Management — "Remove entry?" confirmation dialog                        | `/shows/:showId/entry-management`                             | `e2e-secretary@test.myk9.com` | Desktop  | "Remove entry?" dialog open on a class row                                                  | § 7                  | `ready`                                           |
