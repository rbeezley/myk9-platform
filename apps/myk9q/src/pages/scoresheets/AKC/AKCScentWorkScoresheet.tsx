 ...
 *
 * DEBT-008 Refactoring (2025-11-28):
 * - Now uses useStopwatch hook (was duplicated inline)
 * - Extracted ScoreConfirmationDialog component
 * - Complexity reduced from 43 to ~18
 *
