...
const TemplateEditorPageOriginal: React.FC = () => {
  ...
  const handleClassFieldChange = (field: keyof ClassDefinition, value: unknown) => {
    if (!editingClass) return;
    ...
    <div className="container mx-auto p-6 max-w-full pt-20">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
        ...
        <TabsContent value="fields" className="space-y-6">
          {/* Use FieldBuilder for now since FieldConfigurator has import issues */}
          <FieldBuilder 
            template={template}
            onChange={handleTemplateChange}
            readOnly={!canEdit}
...
export default TemplateEditorPageOriginal;