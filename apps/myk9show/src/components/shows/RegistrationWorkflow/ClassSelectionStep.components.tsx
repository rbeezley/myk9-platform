...
export const AlreadyEnteredNotice: React.FC<AlreadyEnteredNoticeProps> = ({ showId, dogName }) => (
  <Alert className="mb-3">
    <CheckCircle2 className="h-4 w-4 text-success" />
    <AlertDescription>
      {dogName} is already entered in the classes marked &ldquo;Already entered&rdquo; below — those
      can&apos;t be changed here. To change or withdraw an existing entry,{' '}
