...
- [ ] **Schedule-slip communication** — When a ring runs 30+ min behind, auto-emit an exhibitor notification + PA-script generator the secretary can read at the desk. Current slice adds the Today PA-script generator; broadcast wiring remains next. Plan: [`docs/plan-phase-d-schedule-slip-communication.md`](docs/plan-phase-d-schedule-slip-communication.md).
