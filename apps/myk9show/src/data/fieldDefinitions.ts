...
const ELEMENT_OPTIONS: FieldOption[] = [
  ...
  // Agility elements
  { value: 'Standard', label: 'Standard', showTypes: [TrialType.AGILITY] },
  { value: 'Jumpers', label: 'Jumpers with Weaves', showTypes: [TrialType.AGILITY] },
  { value: 'FAST', label: 'FAST', showTypes: [TrialType.AGILITY] },
  { value: 'Time 2 Beat', label: 'Time 2 Beat', showTypes: [TrialType.AGILITY] },
  // Conformation elements
  { value: 'Breed', label: 'Breed', showTypes: [TrialType.CONFORMATION] },
  { value: 'Group', label: 'Group', showTypes: [TrialType.CONFORMATION] },
  { value: 'Best in Show', label: 'Best in Show', showTypes: [TrialType.CONFORMATION] },
];
...
const LEVEL_OPTIONS: FieldOption[] = [
  ...
  { value: 'Premier', label: 'Premier', showTypes: [TrialType.AGILITY] },
];
...
export const FIELD_DEFINITIONS: FieldDefinition[] = [
  ...
  },
  {
    ...
    category: FieldCategory.IDENTITY,
    dataType: FieldDataType.SELECT,
    showTypes: [TrialType.SCENT_WORK, TrialType.AGILITY, TrialType.OBEDIENCE, TrialType.RALLY],
    options: LEVEL_OPTIONS,
    required: true,
  },
  {
    id: 'field-section',
    fieldName: TrialTypeField.SECTION,
    displayName: 'Section',
    description: 'Class section (A, B, C)',
    category: FieldCategory.IDENTITY,
    dataType: FieldDataType.SELECT,
    showTypes: [TrialType.SCENT_WORK, TrialType.AGILITY, TrialType.OBEDIENCE],
    options: [
      { value: 'A', label: 'A' },
      { value: 'B', label: 'B' },
      { value: 'C', label: 'C' },
  ...
  {
    id: 'field-division',
    fieldName: TrialTypeField.DIVISION,
    displayName: 'Division',
    description: 'Competition division',
    category: FieldCategory.IDENTITY,
    dataType: FieldDataType.SELECT,
    showTypes: [TrialType.SCENT_WORK, TrialType.AGILITY],
    options: [
  ...
  // ========== SCHEDULING FIELDS ==========
  {
    ...
    fieldName: TrialTypeField.SCHEDULED_DATE,
  ...
  {
    id: 'field-start-time',
    fieldName: TrialTypeField.START_TIME,
  ...
  },
  {
    ...
    fieldName: TrialTypeField.RING_NUMBER,
  ...
  },
  {
    ...
    fieldName: TrialTypeField.ESTIMATED_DURATION,
  ...
  },
  {
    ...
    fieldName: TrialTypeField.ESTIMATED_JUDGING_TIME,
  ...
  },
  {
    ...
    fieldName: TrialTypeField.CLASS_SETUP_TIME,
  ...
  {
    id: 'field-judge-id',
    fieldName: TrialTypeField.JUDGE_ID,
  ...
  // ========== SCENT WORK SPECIFIC ==========
  {
    ...
    dataType: FieldDataType.NUMBER,
    showTypes: [TrialType.SCENT_WORK],
    minValue: 1,
    maxValue: 5,
    defaultValue: 1,
    required: true,
  ...
  },
  {
    ...
    fieldName: TrialTypeField.SEARCH_TIME_LIMIT,
  ...
  },
  {
    ...
    fieldName: TrialTypeField.SEARCH_ENVIRONMENT,
  ...
  },
  {
    ...
    fieldName: TrialTypeField.STANDARD_COURSE_TIME,
  ...
  {
    id: 'field-sex',
    fieldName: TrialTypeField.SEX,
    displayName: 'Sex',
    description: 'Sex division for the class',
    category: FieldCategory.COMPETITION,
    dataType: FieldDataType.SELECT,
    showTypes: [TrialType.CONFORMATION],
    options: SEX_OPTIONS,
    required: true,
  },
  {
    id: 'field-breed',
    fieldName: TrialTypeField.BREED,
    displayName: 'Breed',
  ...
  },
  {
    ...
    fieldName: TrialTypeField.MINIMUM_AGE,
  ...
  },
  {
    ...
    fieldName: TrialTypeField.CURRENT_ENTRIES,
  ...
  {
    id: 'field-status',
    fieldName: TrialTypeField.STATUS,
    displayName: 'Status',
...
export function getFieldsForTrialType(trialType: TrialType): FieldDefinition[] {
  return FIELD_DEFINITIONS.filter(
    field => field.showTypes.includes('all') || field.showTypes.includes(trialType)
  );
}

// Helper function to get a specific field definition
export function getFieldDefinition(fieldName: TrialTypeField): FieldDefinition | undefined {
