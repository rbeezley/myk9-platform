...
// RPCs. The generated Supabase types include these since the 2026-07-24
// staging deploy; the domain types here narrow the generated plain-string
// grant_type/grant_status columns to their real unions.
