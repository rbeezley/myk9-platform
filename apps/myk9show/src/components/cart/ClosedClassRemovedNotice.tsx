 ...
 *
 * A cart saved in an earlier session is re-checked when it loads, and a class
 * that was cancelled, has started or has finished is taken out so it cannot be
 * paid for. Taking it out silently would be worse than the stale tick it
 * replaces: the exhibitor would simply find a class missing. So the store keeps
 * what it removed, and the wizard's class step and /cart both render this until
 * it is dismissed.
 *
