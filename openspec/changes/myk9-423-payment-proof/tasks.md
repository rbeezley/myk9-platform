...
- [x] 3.1 Run focused payment tests, test TypeScript, lint/format checks and the required shuffled app suite; record actual outcomes and any blockers. The full shuffled suite passed 20,039 tests in 434.57s.
