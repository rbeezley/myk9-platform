...
| Auth/profile/role reads          | `hooks/useAuth.ts`, `hooks/useExhibitorProfile.ts`, admin user dialogs                                             | Keep online/auth-adjacent unless a core offline workflow depends on them.                                                                    |
