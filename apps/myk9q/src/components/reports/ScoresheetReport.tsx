 ...
 */
export const ScoresheetReport: React.FC<ScoresheetReportProps> = ({
  classInfo,
  entries,
  sortOrder,
  showSectionBadge,
            ...
            <th colSpan={4}>
              ...
              <div className="scoresheet-header">
                ...
                <div className="header-columns">
                  ...
                  <div className="header-col">
                    <div>
                      <strong>Req:</strong> Hides: {classInfo.hidesText || '___'} • Distractions:{' '}
                      {classInfo.distractionsText || '___'}
                    </div>
                  </div>
                  <div className="header-col">
                    <div>
