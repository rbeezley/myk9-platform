  ...
  return (
    <div className="flex gap-2 p-4 border-t">
      <input
        ...
        disabled={disabled}
        className="flex-1 rounded-lg bg-muted px-3 py-2.5 text-sm placeholder:text-muted-foreground focus:outline-none focus:ring-2 focus:ring-ring disabled:opacity-50"
      />
      <button
