-- ============================================================================
-- Migration 042: Recreate view_class_summary after results table merge
-- ============================================================================
-- After migration 039 merged results into entries, view_class_summary was
-- dropped by CASCADE. This migration recreates it without the results join.
...
COMMENT ON VIEW public.view_class_summary IS
  'Pre-aggregated class statistics with entry counts. Eliminates N+1 queries for class lists. After migration 039, queries entries table directly (results merged into entries).';
