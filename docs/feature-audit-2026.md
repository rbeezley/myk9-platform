...
| Show Day                   | /at-show, /at-show/:showId | critical-path  | Show hero, self check-in, live results. The old /exhibitor/show-day route was deleted in MYK9-476; the entry point is the ShowTodayBanner on /exhibitor/entries |
