 ...
 * Embedded directly in the print window to avoid external file loading issues.
 * Adapted from myK9Q's reportService.ts PRINT_STYLES.
 */
...
.print-logo .logo-text { font-size: 24px; font-weight: bold; color: #7c3aed; letter-spacing: -0.5px; }
...
.qualified-text { color: #16a34a; font-weight: bold; }
...
@media print {
  ...
  .qualified-text { color: #16a34a !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
...
.logo-text-sm { font-size: 14px; font-weight: bold; color: #7c3aed; }
