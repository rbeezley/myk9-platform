...
describe('MonitoringService', () => {
  ...
  beforeEach(() => {
    ...
    // Reset singleton
    (MonitoringService as unknown as { instance: MonitoringService }).instance =
      undefined as unknown as MonitoringService;
  ...
  describe('Cleanup', () => {
    it('should destroy monitoring service', () => {
      ...
      (
        monitoring as unknown as { performanceMonitor: { observers: unknown[] } }
