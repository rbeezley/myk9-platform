...
- Scheduled/health-snapshot write deltas: ${platform?.scheduledWriteCapture ? (platform.scheduledWriteCapture.enabled ? (platform.scheduledWriteDeltas?.length ?? 'missing') : 'disabled') : 'missing'}
