...
test.describe('Dog Creation GUI Workflows', () => {
  ...
  test.describe('Add Dog Wizard', () => {
    test('should complete full dog creation wizard', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="name-error-message"]')).toContainText(
        'Name is required'
      );
      ...
      await expect(page.locator('[data-testid="review-dog-breed"]')).toContainText(
        'Golden Retriever'
      );
      await expect(page.locator('[data-testid="review-owner-name"]')).toContainText('Jane Smith');
      await expect(page.locator('[data-testid="review-registration-number"]')).toContainText(
        'AKC12345678'
      );
    ...
    test('should save draft and allow resuming', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="draft-saved-message"]')).toContainText(
        'Draft saved'
      );
  ...
  test.describe('Show Creation Workflow', () => {
    test('should create new show through show wizard', async ({ page }) => {
      ...
      await expect(page.locator('[data-testid="show-title"]')).toContainText(
