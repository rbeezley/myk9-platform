...
SELECT
  ...
  e.handler,
  CASE WHEN access.can_view_admin THEN e.entry_fee END AS entry_fee,
  e.submitted_at,
  ...
  CASE WHEN access.can_view_admin THEN e.refund_amount END AS refund_amount,
  ...
  CASE WHEN access.can_view_admin THEN e.discount_amount END AS discount_amount,
