...
| ~~`apps/myk9show/src/services/sync/backgroundSyncService.ts`~~   | ~~104~~          | ~~Fixed 2026-02-15 — uses **APP_VERSION** from Vite define~~            |
...
soft edit-locks to avoid clobbering a shared record): build _presence_ on top of
