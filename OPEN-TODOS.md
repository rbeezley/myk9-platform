...
- [ ] **Wave C — extractions** (multi-concern oversized files only) — Replication-core slice 1 extracts mutation ordering, queue capacity, and localStorage backup helpers with direct tests; remaining Wave C work still includes OCC/backoff/conflict helpers, `ReplicatedTable`, scoring, and Show Map extractions.
