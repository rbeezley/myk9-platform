...
**Status:** Draft plan created 2026-06-05; verified and expanded 2026-06-05. PR 1 implemented 2026-06-05.
...
- [ ] **Step 1: Choose the consolidation shape before coding**
...
- [ ] **Step 3: Write failing wizard-mode test**
...
- [ ] **Step 4: Replace the dialog launch**
...
- [ ] **Step 5: Apply late-entry context in the wizard**
...
- [ ] Run the existing late-entry walk tests and update/remove assertions that expect `createDayOfEntry` if the UI no longer calls it:
...
- [ ] Run focused registration workflow tests touched by the late-entry route:
...
- [ ] Update this plan's PR 2 status with the selected implementation and PR number.
