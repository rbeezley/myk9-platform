...
BEGIN
  FOR v_row IN
    ...
    ('people_private','SELECT,INSERT,UPDATE,DELETE','','SELECT,INSERT,UPDATE,DELETE,TRUNCATE,REFERENCES,TRIGGER,MAINTAIN'),
    ...
    ('show_officials','SELECT,INSERT,UPDATE,DELETE','','SELECT,INSERT,UPDATE,DELETE,TRUNCATE,REFERENCES,TRIGGER,MAINTAIN'),
...
BEGIN
  ...
  WHERE n.nspname = 'public'
    ...
    AND c.relname NOT IN (
      ...
      'show_messages','show_money_locks','show_officials','show_passcodes','show_payouts',
      'show_templates',
