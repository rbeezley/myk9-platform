# cart-integrity Specification

## Purpose
The entry cart never lets an exhibitor pay into a show whose entries have closed, always surfaces a non-empty cart in the exhibitor's navigation, and expires stale items at entries-close — enforced both client-side and server-side.
