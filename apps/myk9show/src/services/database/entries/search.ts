 ...
 *
 * The account-level own-entry read that used to live here (`getUserEntries`,
 * `USER_ENTRIES_SELECT` and the replica helpers) moved to
 * `./userEntriesRead.ts` in MYK9-563; both are re-exported from the barrel.
 */
