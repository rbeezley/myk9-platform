      ...
      <div className="space-y-8">
        ...
        <div className="group relative overflow-hidden bg-gradient-to-br from-card to-card/80 border border-border rounded-2xl p-6 shadow-sm backdrop-blur-xl transition-all duration-500 hover:shadow-xl hover:-translate-y-2">
          ...
          <div className="relative">
            ...
            <AppleFormGrid>
              <AppleFormField label="Show Name" required>
                <Input
                  value={show.name || ''}
              ...
              <AppleFormField label="Show Type" required>
                <Select
                  value={show.type || ''}
              ...
              <AppleFormField label="Start Date" required>
                <DateTimePicker
              ...
              <AppleFormField label="End Date" required>
                <DateTimePicker
              ...
              <AppleFormField label="Location" required className="col-span-2">
                <Textarea
                  value={show.location || ''}
        ...
        <div className="group relative overflow-hidden bg-gradient-to-br from-card to-card/80 border border-border rounded-2xl p-6 shadow-sm backdrop-blur-xl transition-all duration-500 hover:shadow-xl hover:-translate-y-2">
          ...
          <div className="relative">
            ...
            <AppleFormGrid>
            <AppleFormField label="Host Club" required className="col-span-2">
        ...
        <div className="group relative overflow-hidden bg-gradient-to-br from-card to-card/80 border border-border rounded-2xl p-6 shadow-sm backdrop-blur-xl transition-all duration-500 hover:shadow-xl hover:-translate-y-2">
          ...
          <div className="relative">
            ...
            <AppleFormGrid>
            <AppleFormField label="Show Chairman" required>
              <div className="space-y-3">
                <Select
                  value={show.chairman || ''}
            ...
            <AppleFormField label="Show Secretary" required>
              <div className="space-y-3">
                <Select
        ...
        <div className="group relative overflow-hidden bg-gradient-to-br from-card to-card/80 border border-border rounded-2xl p-6 shadow-sm backdrop-blur-xl transition-all duration-500 hover:shadow-xl hover:-translate-y-2">
          ...
          <div className="relative">
            ...
            <AppleFormGrid>
            <AppleFormField label="Entry Opens" required>
              <DateTimePicker
            ...
            <AppleFormField label="Entry Closes" required>
              <DateTimePicker
            ...
            <AppleFormField label="Pre-Entry Fee ($)">
              <Input
                type="number"
                min="0"
                step="0.01"
            ...
            <AppleFormField label="Day-of-Show Fee ($)">
              <Input
                type="number"
                min="0"
                step="0.01"
