...
| [`post-payout-clawback.md`](post-payout-clawback.md)   | A refund is owed (or a dispute was lost) **after** the club's payout settled: the manual Stripe refund + transfer reversal procedure, the entry/ledger stamps, and what will not tie out afterward.                                              |
