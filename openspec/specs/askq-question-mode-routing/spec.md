# askq-question-mode-routing

## Purpose

Defines AskQ's user-selected question modes and the source-grounding boundaries for App help, Rules, and This show questions. Introduced by `askq-question-routing-and-rule-scope` to keep AskQ answers simple, reliable, and grounded in the right type of evidence.
