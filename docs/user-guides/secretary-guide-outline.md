...
**Status:** `walkthrough-needed` — **Close Out Show** now exists in Show Desk and queues completed-state updates for the show, open trials, and open classes. Do not mark this section final until a seeded closeout walkthrough verifies reports, submission history, closeout, and sync evidence.

**Draft steps (to verify in walkthrough):**

1. From the Show Desk Closeout section, click **Close Out Show**.
2. Review any closeout concerns shown by myK9.
3. Confirm the action → the show, open trials, and open classes are marked completed.
4. Confirm the completed show remains available with Reports and Submit Results history.
...
| ------------------------------------------------ | ------- | -------------------------------------------------------------------------- |
| Close Out Show walkthrough evidence missing      | § 11    | Verify seeded report/submission/closeout/sync path before final guide copy |
