        ...
        <div className="group relative overflow-hidden bg-gradient-to-br from-card to-card/80
          ...
          <div className="relative flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold mt-2 group-hover:text-warning transition-colors duration-300">
        ...
        <div className="group relative overflow-hidden bg-gradient-to-br from-card to-card/80
          ...
          <div className="relative flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold mt-2 group-hover:text-success transition-colors duration-300">
