...
import { OfflineEntryCreator, type EntryCreationOptions, type EntryCreationResult, type BatchEntryCreationResult } from '@/services/entries/OfflineEntryCreator';
import { EntryLimitChecker, type EntryLimitCheckResult } from '@/services/entries/EntryLimitChecker';
...
export interface OfflineEntryCreationActions {
  createEntry: (entryData: ShowEntryInput, options?: EntryCreationOptions) => Promise<EntryCreationResult>;
  createBatchEntries: (entriesData: ShowEntryInput[], options?: EntryCreationOptions) => Promise<BatchEntryCreationResult>;
...
export interface UseOfflineEntryCreationResult extends OfflineEntryCreationState, OfflineEntryCreationActions {}
...
export function useOfflineEntryCreation(): UseOfflineEntryCreationResult {
   ...
   */
  const createBatchEntries = useCallback(async (
   ...
   */
  const scratchEntry = useCallback(async (
    entryId: string,
    reason: string
