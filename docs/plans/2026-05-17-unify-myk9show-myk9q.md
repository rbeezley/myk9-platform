...
- Phase 4 sunset happens after the pilot show plus one more clean show. As of the 2026-05-31 synthetic transport pilot, Phase 4B sunset/deployment work remains blocked on a real browser/device push-tap verification. Phase 4A code cleanup may remove duplicate myK9Show surfaces once `/at-show` has replacement coverage.
