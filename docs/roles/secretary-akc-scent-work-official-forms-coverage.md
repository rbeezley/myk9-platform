...
| Entry Form Template | `docs/AKC-forms/SW-EntryForm.pdf` | Reports -> AKC Scent Work Entry Form | Partially wired | The app renders an in-app printable entry form and now fills the official AKC PDF for one selected dog. Remaining work: combined packet output for all dogs and launch verification against current AKC expectations. |
...
1. **Entry Form Template official PDF fill.** Initial selected-dog PDF fill is wired. Next decide whether the secretary also needs one-click combined packet output for all dogs.
