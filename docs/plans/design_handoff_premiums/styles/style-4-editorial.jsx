...
function S4Page({ children, runningHead, foot, cream }) {
  return (
    <div className="sheet" data-cream>
      ...
      <div
        className="s4-page"
        style={{ paddingTop: 64, paddingBottom: 80, height: '100%', boxSizing: 'border-box' }}
      >
        {children}
      </div>
      {foot && (
        <div className="s4-running-foot">
          <span>{foot.l}</span>
          <span>{foot.r}</span>
        </div>
      )}
...
function Style4Editorial() {
  return (
    <div className="premium-doc s4">
        ...
        <div className="s4-cover">
          ...
          <div className="s4-cover-art">
            <image-slot
              id="s4-cover-photo"
              shape="rect"
              placeholder="Drop venue photo or club crest (optional)"
            ...
            <div className="s4-cover-art-fallback">
              ...
              <div className="rows">
                <div className="r">
                  ...
                  <span className="v">Six over three days</span>
                </div>
                <div className="r">
                  <span className="k">Elements</span>
                  <span className="v">Container · Buried · Interior · Exterior</span>
                </div>
                <div className="r">
                  <span className="k">Levels</span>
                  <span className="v">Novice through Detective</span>
                </div>
                <div className="r">
                  <span className="k">Sanctioning</span>
                  <span className="v">A.K.C. Licensed</span>
                </div>
                <div className="r">
                  <span className="k">Field Limit</span>
                  <span className="v">{R.entryLimits.total} runs</span>
                </div>
              </div>
            </div>
          </div>
          <div className="s4-cover-bottom">
            <div className="left">
              An AKC-licensed scent work trial held in San Antonio over three days, judged by
              Cynthia Beagles &amp; Marcus Whitfield.
            </div>
            <div className="right">
              {R.dateRange}
              <br />
      ...
      <S4Page
        runningHead={`${R.club} · Premium List`}
        foot={{ l: 'Spring Scent Work Trial', r: 'p. 02' }}
      >
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 48, height: '100%' }}>
          <div>
            ...
            <div className="s4-toc">
              ...
              <span className="t">The Trial</span>
              <span className="pg">04</span>
              <span className="num">02</span>
              <span className="t">Judges &amp; Assignments</span>
              <span className="pg">05</span>
              <span className="num">03</span>
              <span className="t">Classes &amp; Elements</span>
              <span className="pg">06</span>
              <span className="num">04</span>
              <span className="t">Schedule of Events</span>
              <span className="pg">06</span>
              <span className="num">05</span>
              <span className="t">Fees, Limits, Entry Methods</span>
              <span className="pg">07</span>
              <span className="num">06</span>
              <span className="t">Awards &amp; Notices</span>
              <span className="pg">07</span>
              <span className="num">07</span>
              <span className="t">Lodging &amp; Officers</span>
          ...
          <div>
            ...
            <div className="s4-eyebrow" style={{ marginTop: 32 }}>
              About the club
            </div>
            <div className="s4-rule" />
            <p
      ...
      >
        ...
        <div className="s4-rule" />
        <p className="s4-lede" style={{ marginBottom: 24 }}>
          {R.trialInformationNarrative}
        </p>

        <div className="s4-pullquote">"{R.tagline}"</div>
        ...
        {R.judges.map((j, i) => (
          <div className="s4-judge-card" key={i}>
            <div className="s4-judge-portrait">
              {j.name
                .split(' ')
                .map(n => n[0])
                .join('')}
      ...
      <S4Page
        runningHead={`${R.club} · Premium List`}
        foot={{ l: 'Classes · Schedule · Fees', r: 'p. 06 — 07' }}
      >
        ...
        <div className="s4-2col">
          {R.classes.map((c, i) => (
            <p key={i}>
              <strong style={{ fontFamily: '"Playfair Display", serif', fontSize: 16 }}>
                {c.level}.
              </strong>{' '}
        ...
        <div style={{ marginTop: 36 }} className="s4-eyebrow">
          Section Four — A Day at the Trial
        </div>
        <div className="s4-rule" />
        <p
          style={{
        ...
        <div className="s4-fees">
          <div className="s4-fee">
            <div className="n">${R.fees.firstEntry}</div>
            <div className="l">First Entry</div>
          </div>
          <div className="s4-fee">
            <div className="n">${R.fees.additional}</div>
            <div className="l">Additional</div>
          </div>
          <div className="s4-fee">
            <div className="n">${R.fees.junior}</div>
            <div className="l">Junior Handler</div>
          </div>
        </div>
        <p
          style={{
      ...
      <S4Page
        runningHead={`${R.club} · Premium List`}
        foot={{ l: 'Lodging · Committee', r: 'p. 08' }}
      >
        ...
        <div style={{ marginTop: 24, display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 32 }}>
          <div>
            ...
            <div style={{ fontFamily: '"EB Garamond", serif', fontSize: 13, color: '#3e362a' }}>
              {R.vetClinic.address}
            </div>
            <div
              style={{
        ...
        <div style={{ marginTop: 24 }} className="s4-eyebrow">
          Officers &amp; Committee
        </div>
        <div className="s4-rule" />
