...
- [ ] **Wave D — replication-bypass reroutes + targeted test additions** — Secretary status/bulk status writes, secretary Entry Management reads, armband read/write reroutes, and day-of scratch/move-up reads are implemented; remaining slices: secretary check-in report adapter and exhibitor show-day data adapter.
