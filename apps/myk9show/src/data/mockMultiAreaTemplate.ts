import { ClassTemplate, ShowType, Organization, TemplateStatus, TemplateType } from '@/types/template.types';
import { ShowTypeField } from '@/types/field-definition-types';
...
export const MOCK_SCENT_WORK_TEMPLATE_WITH_FIELDS: ClassTemplate = {
  ...
  // Metadata
  description: 'Demonstration template showing multiple search area time limits for Interior Master classes',
