          ...
          <AlertDialogDescription>
            {actionDialog.action === 'offer' ? (
              <>
                ...
                <strong>{actionDialog.entry?.dog?.call_name ?? actionDialog.entry?.dog?.name}</strong> in{' '}
              ...
              <>
                ...
                <strong>{actionDialog.entry?.dog?.call_name ?? actionDialog.entry?.dog?.name}</strong> from the waitlist for{' '}
