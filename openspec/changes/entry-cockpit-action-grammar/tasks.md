...
- [ ] 6.1 Run focused vitest suites for all touched areas plus `pnpm typecheck`; note any pre-existing hangs separately.
- [ ] 6.2 Secretary browser walk on desktop + 390 px: queue triage → focused card accept/reject → status menu marking/guard → Entries tab link; record evidence.
