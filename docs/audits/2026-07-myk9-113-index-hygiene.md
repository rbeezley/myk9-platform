...
| Valid/ready duplicate guard                 | RED → PASS   | OpenSpec verification found that physical-signature comparison did not require both twins to be valid and ready. A new focused assertion failed first; the strengthened migration then passed 3/3 tests and two executions against a disposable vanilla PostgreSQL schema.                                 |
