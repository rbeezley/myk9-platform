...
| S-07    | Entry Management — Pending tab                                                | `/shows/:showId/entry-management`                             | `e2e-secretary@test.myk9.com` | Desktop  | At least one entry card in Pending tab                                                      | § 4 Entry Management | `ready`                                           |
| S-08    | Entry Management — entry card with Accept / Reject / Waitlist actions visible | `/shows/:showId/entry-management`                             | `e2e-secretary@test.myk9.com` | Desktop  | Three-dot menu open on an entry card                                                        | § 4                  | `ready`                                           |
| S-09    | Entry Management — bulk select + action bar                                   | `/shows/:showId/entry-management`                             | `e2e-secretary@test.myk9.com` | Desktop  | Two or more entries checked; sticky "Approve selected" bar visible                          | § 4                  | `ready`                                           |
