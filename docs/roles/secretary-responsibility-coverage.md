...
| Generate required UKC Nose Work closeout materials.                                                               | Required   | Reports infrastructure plus UKC Trial Report official PDF    | Partially covered | UKC Trial Report official PDF fill is registered, selected for UKC trial secretary reports, and tested. Remaining UKC judges books, trial score sheet, entry/change-entry fills, paperwork submission guidance, and print evidence still need remediation. See [`secretary-registry-closeout-verification.md`](secretary-registry-closeout-verification.md).                                                                 |
