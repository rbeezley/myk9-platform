...
- [x] **Add an approval workflow for sign-up role requests** — Implemented in `docs/superpowers/plans/2026-05-24-club-role-approval.md`: signup now records club access requests, site admins can review them, approved club admins can manage club-scoped secretaries, show secretary selection is club-scoped, and broad secretary people/dog write paths are routed through show-scoped RPCs. Add PR reference after merge.
