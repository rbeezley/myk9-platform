...
- **WHEN** the migration runs against a person with a date of birth or supported registry identifier
- **THEN** an equivalent private record is created for that person
