        ...
        if (optionClicked) {
          ...
          if (editOpened) {
            ...
            await page.screenshot({
              path: 'screenshots/debug-edit-panel-open.png',
              fullPage: true,
            });
            ...
            if (contentChecks.hasOldEditProfile && !contentChecks.hasEditUser) {
              console.log(
                '⚠️ WARNING: Still showing old "Edit Profile" dialog instead of new UserEditPanel!'
              );
        ...
        for (const route of profileRoutes) {
          try {
            ...
            if (content && !content.includes('Sign in to your account')) {
              ...
              await page.screenshot({
                path: `screenshots/debug-${route.replace('/', '')}-page.png`,
                fullPage: true,
              });
              break;
            }
