...
import { detectFrequentOverrides } from '../detectFrequentOverrides';
...
describe('detectFrequentOverrides', () => {
  ...
  it('handles multiple fields independently', () => {
    ...
    const result = detectFrequentOverrides(gens);
