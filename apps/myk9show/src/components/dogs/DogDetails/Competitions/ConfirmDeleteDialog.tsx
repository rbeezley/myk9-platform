    ...
    <CommonDialog
      ...
      footer={
        <>
          ...
          <button
            type="button"
            className="inline-flex items-center px-4 py-2 rounded-lg bg-destructive text-destructive-foreground hover:bg-destructive/90 transition font-semibold shadow-sm focus:outline-none focus:ring-2 focus:ring-destructive"
            onClick={onConfirm}
          >
            <svg
