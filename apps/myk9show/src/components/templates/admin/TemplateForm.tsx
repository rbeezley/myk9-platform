...
import { ClassTemplate, Organization, TrialType } from '../../../types/template.types';
...
export const TemplateForm: React.FC<TemplateFormProps> = ({
  ...
  const trialTypes = Object.values(TrialType);

  const handleChange = (
    field: keyof ClassTemplate,
    value: string | boolean | Organization | TrialType
  ) => {
    if (readOnly) return;
      ...
      <Card>
        ...
        <CardContent className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <Label htmlFor="trialType">Show Type *</Label>
              <Select
                value={template.trialType || ''}
                onValueChange={value => handleChange('trialType', value as TrialType)}
                disabled={readOnly}
              >
                <SelectTrigger>
