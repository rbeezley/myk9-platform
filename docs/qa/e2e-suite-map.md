...
| `apps/myk9show/src/test/e2e/tabsTriggerAriaSelectedComputedStyle.spec.ts`   | MYK9-612: Edit Dog panel active-tab computed style (`aria-selected`, not Radix's `data-state=active`, is what Base UI's Tabs primitive sets). Exhibitor-authed, read-only, never saves.                                                                                                                                                                                                      |
