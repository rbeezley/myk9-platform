/**
 * AKC FastCAT Scoresheet (myK9Q Wrapper)
 *
 * Thin wrapper around the shared AKCFastCatLiveScoresheet from @myk9/scoring-ui.
...
import { AKCFastCatLiveScoresheet } from '@myk9/scoring-ui';
...
export const AKCFastCatScoresheet: React.FC = () => {
  ...
  const core = useScoresheetCore({ sportType: 'AKC_FASTCAT' });
