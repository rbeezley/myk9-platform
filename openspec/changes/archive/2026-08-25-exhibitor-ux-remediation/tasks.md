...
- [x] 7.4 Open and review the final implementation PR(s), record CI evidence, and merge before archive. **Completed 2026-08-25:** PR #1799 passed the full required pipeline and merged as `0e39b2cdcc604b9f8b84871de54927fbe345b16b`; the Vercel myK9Show preview was rate-limited and non-required per the repository runbook.
- [x] 7.5 Update the Linear pointer issue with implementation/verification evidence and archive this change only after every required PR is merged. **Completed 2026-08-25:** MYK9-88 is Done with PR #1799 attached; the change is synced and archived in the post-merge close-out PR.
