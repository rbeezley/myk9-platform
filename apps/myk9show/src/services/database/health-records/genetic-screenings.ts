...
export type DbGeneticScreeningInsert = Database['public']['Tables']['genetic_screenings']['Insert'];
export type DbGeneticScreeningUpdate = Database['public']['Tables']['genetic_screenings']['Update'];
