...
const TemplateEditorPageTest: React.FC = () => {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="border border-dashed border-muted-foreground/25 rounded-lg p-12 text-center">
          <div className="max-w-md mx-auto">
            <h2 className="text-xl font-semibold mb-4">Testing TemplateForm Import</h2>
            <p className="text-muted-foreground mb-6">
              If you can see this, TemplateForm import works.
            </p>
...
export default TemplateEditorPageTest;