# askq-rulebook-scope-selection

## Purpose

Defines how AskQ selects, validates, and labels rulebook scope for official rules questions. Introduced by `askq-question-routing-and-rule-scope` so rule answers do not silently guess between organizations or sports.
