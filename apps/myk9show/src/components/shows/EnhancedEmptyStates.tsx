    ...
    switch (tab) {
      case 'all': {
        ...
        return {
          ...
          actionLabel: canCreateShowsAll ? 'New Show' : 'Find Local Shows',
      ...
      case 'past':
        return {
          ...
          title: 'No Past Shows',
          description:
            "You haven't participated in any completed shows yet. Register for upcoming shows to build your competition history.",
      ...
      case 'entries':
        return {
          ...
          description:
            "You haven't entered any shows yet. Browse available shows and register to start competing.",
      ...
      case 'assignments':
        return {
          ...
          description:
            "You don't have any current judging assignments. Your assignments will appear here when show organizers assign you to judge.",
  ...
  return (
    <Card className="bg-card/95 backdrop-blur-sm border-border/50 shadow-sm">
      <CardContent className="p-12 text-center">
        ...
        <h3 className="text-xl font-semibold mb-3 tracking-tight">{content.title}</h3>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="text-left">
                ...
                <p className="text-sm text-muted-foreground">
                  Browse shows by location and discipline to find events that match your interests
