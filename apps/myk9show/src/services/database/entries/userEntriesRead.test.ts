/**
 * Tests for the account-level own-entry read.
 *
 * Moved here with `getUserEntries` itself when MYK9-563 item 7 split it out of
 * `search.ts`; the cases are unchanged from `search.test.ts`.
 */
