...
- [x] 6.3.3 Run the colocated tests for every file touched, plus tests found by grepping for the changed function names — not only colocated ones. (68 tests across 10 focused files passed for this dog-record slice; typecheck and lint also pass.)
