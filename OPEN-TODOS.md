...
- [ ] **Schedule-slip communication** — When a ring runs 30+ min behind, auto-emit an exhibitor notification + PA-script generator the secretary can read at the desk. PR #239 added the Today PA-script generator; current slice posts the generated copy to the existing show-announcement broadcast lane. Push delivery remains gated until target audience and RLS behavior are verified. Plan: [`docs/plan-phase-d-schedule-slip-communication.md`](docs/plan-phase-d-schedule-slip-communication.md).
