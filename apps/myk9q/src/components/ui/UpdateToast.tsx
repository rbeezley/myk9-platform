...
const styles = {
  ...
  message: cn('m-0 text-[0.9375rem] font-medium leading-[1.4]', 'text-[var(--foreground)]'),
  actions: cn('flex flex-col gap-[var(--token-space-xs)] flex-shrink-0', 'min-[400px]:flex-row'),
  btn: cn(
