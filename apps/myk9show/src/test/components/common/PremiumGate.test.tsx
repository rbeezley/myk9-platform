...
describe('PremiumGate Component', () => {
  describe('Rendering', () => {
    it('should render with title and description', () => {
      render(
        <PremiumGate title="Premium Feature" description="This is a premium feature description." />
      );
    ...
    it('should render upgrade button', () => {
      render(<PremiumGate title="Test Feature" description="Test description" />);
    ...
    it('should render with custom icon when provided', () => {
      render(<PremiumGate title="Test Feature" description="Test description" icon={Trophy} />);
  ...
  describe('Size Variants', () => {
    it('should render with small size', () => {
      const { container } = render(
        <PremiumGate title="Small Gate" description="Small description" size="sm" />
      );
    ...
    it('should render with medium size (default)', () => {
      const { container } = render(
        <PremiumGate title="Medium Gate" description="Medium description" />
      );
    ...
    it('should render with large size', () => {
      const { container } = render(
        <PremiumGate title="Large Gate" description="Large description" size="lg" />
      );
