...
- [ ] 4.6 Run the migration no-op guard contract red before the forward migration and green after it; use the isolated two-pass workflow as the database behavioral test.
