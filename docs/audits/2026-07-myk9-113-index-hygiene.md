...
| Additive migration source contract          | PASS         | 2026-07-28: 2/2 focused tests passed; 78 exact pairs, fail-closed name collisions, strict coverage postcondition, and no drops. A read-only remote catalog check found 0 existing intended names.                                                                                                          |
