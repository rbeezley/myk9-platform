...
const SystemInformationCard: React.FC<SystemInformationCardProps> = ({ person, dogCount }) => {
  return (
    <Card
    ...
    >
      <div
        className="absolute inset-0 bg-gradient-to-br from-red-500/[0.01] to-transparent
      ...
      <div className="relative space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            ...
            <span className="text-sm font-medium text-foreground">{dogCount} associated dogs</span>
          </div>
        </div>
      </div>
    </Card>
