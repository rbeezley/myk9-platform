...
> **Shipped status (2026-06-27):** Phases 1–3 + Phase 4 *voluntary withdrawal* (#967/#969/#970/#973) are **merged AND deployed** — 3 migrations pushed (`20260625200000`, `20260626000000`, `20260627000000`; columns/trigger/grants verified live via `has_column_privilege`), `stripe-webhook` (v66) + `stripe-payment-link` (v4) redeployed. Remaining: Phase 4 *show-cancellation make-whole* (`stripe-refund-show`, this PR) + its deploy.
