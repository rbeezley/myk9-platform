-- Fix submit_show_entries: migration 180 returned entry_ids/entry_pairs keys but
-- the client expects an 'entries' key (same shape as migration 164). Also retains
-- the handler_id write and the correct trial_id join for class-fee lookup.
