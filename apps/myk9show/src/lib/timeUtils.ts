 ...
 */
export function msToDisplay(ms: number, precision: TimeDisplayPrecision = 'seconds'): string {
 ...
 */
export function isValidTimeFormat(timeString: string, allowHundredths: boolean = true): boolean {
 ...
 */
export function getTimeDisplayPrecision(
  context: 'template' | 'result' | 'estimate'
 ...
 * Falls back to a short date for dates older than 7 days.
 */
