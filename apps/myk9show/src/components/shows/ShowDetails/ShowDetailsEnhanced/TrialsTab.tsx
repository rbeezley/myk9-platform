...
import { Calendar, Clock, Eye, ArrowRight, Grid3X3, Table2 } from 'lucide-react';
                ...
                <div className="flex items-center justify-between">
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex items-center gap-2 text-gray-600">
                            ...
                            <span className="text-sm">
                              {formatDistanceToNow(new Date(trial.trialDate), {
                                addSuffix: true,
                              })}
                            </span>
                          </div>
                  ...
                  <Button
                    ...
                    onClick={() =>
                      navigate(
                        trial.showId
                          ? `/shows/${trial.showId}/trials/${trial.id}`
                          : `/trials/${trial.id}`
                      )
                    }
