  ...
  const stats = [
    {
      title: 'System Roles',
      value: '4',
      description: 'Built-in role types',
      icon: Shield,
      ...
      <div className="container mx-auto px-6 pt-20 pb-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {stats.map((stat) => {
            ...
            return (
              <Card key={stat.title} className="group relative overflow-hidden bg-gradient-to-br from-card to-card/80 
                ...
                <div className="relative">
                  ...
                  <Button asChild variant="ghost" size="sm" className="w-full">
                    <Link to={stat.link} className="hover:bg-primary/10 transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {quickActions.map((action) => {
            ...
            return (
              <Card key={action.title} className="group relative overflow-hidden bg-gradient-to-br from-card to-card/80 
                                                   border border-border rounded-2xl p-6 shadow-sm backdrop-blur-xl 
                                                   transition-all duration-500 hover:shadow-xl hover:-translate-y-2">
                <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-transparent 
                                 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                <div className="relative">
                  <div className="flex items-start gap-4">
                    <div className={`${action.color} rounded-2xl p-3 shadow-sm group-hover:shadow-xl 
                    ...
                    <div className="flex-1">
                      ...
                      <Button asChild variant="ghost" className="p-0 h-auto hover:bg-primary/10 transition-colors duration-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <Card className="group relative overflow-hidden bg-gradient-to-br from-card to-card/80 
            ...
            <CardContent className="relative">
              <div className="space-y-2">
                {userRoles.length > 0 ? (
                  userRoles.map(ur => (
                    <div key={ur.id} className="flex items-center justify-between p-3 border border-border/50 rounded-lg 
          ...
          <Card className="group relative overflow-hidden bg-gradient-to-br from-card to-card/80 
            ...
            <CardHeader className="relative">
              ...
              <CardDescription>
                Overview of your current permission level
              </CardDescription>
            </CardHeader>
            <CardContent className="relative">
              <div className="space-y-4">
                <div className="flex items-center justify-between p-3 bg-muted/30 rounded-lg">
                  ...
                  <Badge variant="outline" className="bg-background/50">{userPermissions.length}</Badge>
                </div>
                <div className="flex items-center justify-between p-3 bg-muted/30 rounded-lg">
                  <span className="text-sm font-medium">Effective Permissions:</span>
                  <Badge variant="outline" className="bg-background/50">{effectivePermissions.length}</Badge>
                </div>
                <div className="pt-2">
                  <Button asChild variant="outline" size="sm" className="w-full border-primary/20 text-primary 
                                                                            hover:bg-primary/5 hover:border-primary/40 
                                                                            transition-all duration-300">
                    <Link to="/admin/rbac-test">
        ...
        <Card className="group relative overflow-hidden bg-gradient-to-br from-card to-card/80 
          ...
          <CardHeader className="relative">
            ...
            <CardDescription>
              Current status of the RBAC system
            </CardDescription>
          </CardHeader>
          <CardContent className="relative">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="flex items-center gap-3 p-3 bg-success-green/10 rounded-lg border border-success-green/20">
                <div className="w-3 h-3 bg-success-green rounded-full shadow-sm"></div>
                <span className="text-sm font-medium">Database Connected</span>
              </div>
              <div className="flex items-center gap-3 p-3 bg-success-green/10 rounded-lg border border-success-green/20">
                <div className="w-3 h-3 bg-success-green rounded-full shadow-sm"></div>
                <span className="text-sm font-medium">Permission Cache Active</span>
              </div>
              <div className="flex items-center gap-3 p-3 bg-success-green/10 rounded-lg border border-success-green/20">
                <div className="w-3 h-3 bg-success-green rounded-full shadow-sm"></div>
