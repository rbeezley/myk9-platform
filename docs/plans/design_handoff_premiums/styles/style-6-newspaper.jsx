        ...
        <div className="s6-page">
          ...
          <div className="s6-cols s6-cols-2u">
            <div>
              ...
              <div className="s6-subdeck">
                Six trials over three days at Live Oak Civic Center; entries open April fifteenth,
                close June third at eight o'clock in the evening.
              </div>
            ...
            <div>
              ...
              <div className="s6-img-cap">
                "The grounds at Live Oak — climate-controlled and well lit, with crating in the
                adjacent hall."
              </div>
        ...
        <div className="s6-page">
          ...
          >
            <div style={{ flex: '0 0 40%' }}>
              <div className="s6-h-section" style={{ marginTop: 0 }}>
                From the Chair
              </div>
              <p
                style={{
              ...
              >
                — {RN.trialCommittee[0].name}, {RN.trialCommittee[0].role}
              </p>
            </div>
            <div style={{ flex: 1 }}>
              <div className="s6-pull" style={{ margin: 0 }}>
                "{RN.tagline}"
              </div>
            </div>
          </div>
          ...
          >
            {RN.showHoursNarrative} {RN.aboutTheClub}
          </p>
        ...
        <div className="s6-page">
          ...
          <div className="s6-ad-grid">
            <div className="s6-ad">
              ...
              <div className="bd">
                <b>The fastest path.</b> Visit myk9show.com/bckc-spring-2026. Pay by card; receive
                instant confirmation. Closes {RN.closingTime} on {RN.closingDate}.
              </div>
            </div>
            <div className="s6-ad">
              <div className="hd">Entry — By Mail</div>
              <div className="bd">
                <b>Old-fashioned, reliable.</b> {RN.entryMethods[1].detail}. Postmark must precede
                closing.
              </div>
            </div>
            <div className="s6-ad">
              ...
              <div className="bd">
                <b>PDF and a payment ref.</b> {RN.entryMethods[2].detail}.
              </div>
            </div>
            {RN.hotels.map((h, i) => (
              <div className="s6-ad" key={i}>
                ...
                <div className="bd">
                  <b>{h.distance}</b> from venue. <b>{h.rate}</b>/night with code <b>{h.code}</b>.
            ...
            <div className="s6-ad">
              ...
              <div className="bd">
                <b>${RN.fees.firstEntry}.00</b> per dog, per trial. Additional entries{' '}
                <b>${RN.fees.additional}.00</b>. Junior handlers <b>${RN.fees.junior}.00</b>.
              </div>
            </div>
            <div className="s6-ad">
            ...
            <div className="s6-ad">
              ...
              <div className="bd">
                <b>{RN.vetClinic.name}</b>
                <br />
                {RN.vetClinic.address}
                <br />
                {RN.vetClinic.phone}
              </div>
            </div>
            ...
            <div className="s6-ad">
              ...
              <div className="bd">
                <b>{RN.trialCommittee[1].name}</b>
                <br />
                {RN.trialCommittee[1].contact}
              </div>
            </div>
          </div>
          ...
          <div className="s6-cols s6-cols-2">
            <div>
              {RN.notices.map((n, i) => (
                <p
                  key={i}
                  style={{ borderLeft: '3px solid #a83a1d', paddingLeft: 12, margin: '0 0 12px' }}
                >
                  <span
                    style={{
                      fontFamily: '"IBM Plex Mono", monospace',
                  ...
                  >
                    Notice {String(i + 1).padStart(2, '0')}.
                  </span>
                  <br />
                  {n}
                </p>
