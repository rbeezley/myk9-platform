...
- [ ] **Wave D — replication-bypass reroutes + targeted test additions** — Secretary status/bulk status writes, secretary Entry Management reads, armband read/write reroutes, day-of scratch/move-up reads, and the secretary check-in report adapter are implemented; remaining slice: exhibitor show-day data adapter.
