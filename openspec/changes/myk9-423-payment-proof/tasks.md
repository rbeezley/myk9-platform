...
- [ ] 3.1 Run focused payment tests, test TypeScript, lint/format checks and the required shuffled app suite; record actual outcomes and any blockers. Current-head full-suite evidence is pending the final fallback-review fixes.
