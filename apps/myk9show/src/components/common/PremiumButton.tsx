...
export function PremiumButton({
  ...
  return (
    <Button type={type} className={buttonClassName} onClick={onClick} disabled={isDisabled}>
...
export function CTAButton({ size = 'lg', className, ...props }: CTAButtonProps) {
  return (
    <PremiumButton
      variant="primary"
      size={size}
      className={cn('shadow-lg hover:shadow-xl font-semibold', className)}
      {...props}
    />
  );
}
