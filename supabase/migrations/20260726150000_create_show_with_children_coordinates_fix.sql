-- Corrective replacement for 20260726140000, which rebuilt
-- create_show_with_children from a STALE base (20260510143000), dropping the
-- registry_id trials column (20260630120000) and the person_id/status
-- judge-assignment handling (20260618120000). This version re-applies the true
-- latest function body with only the venue latitude/longitude addition.
