...
| 2 — MP-03       | Merged + functions redeployed + staging-verified                     | PR #1170; assertion-first focused tests red then green; affected Stripe functions redeployed 2026-07-06 14:21:03 UTC. On 2026-07-13, a controlled sandbox payment-link charge settled and manual resend of the same `checkout.session.completed` left the link and entry paid, with no refund. |
| 3 — MP-04/MP-14 | Merged + DB-pushed + functions redeployed + staging-verified         | PR #1170; migration `20260706013906_stripe_livemode_scoped_ids.sql` applied to `sojmvhhwsjxmfistvzbe`; dry-run now reports remote DB up to date; affected Stripe functions redeployed 2026-07-06 14:21:03 UTC. On 2026-07-13, authenticated E2E cart-checkout resolved only a `livemode=false` customer and rejected an empty cart before creating a Checkout session or charge; the probe cart was abandoned. |
