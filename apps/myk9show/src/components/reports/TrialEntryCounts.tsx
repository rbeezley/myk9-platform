...
export const TrialEntryCounts: React.FC<ReportProps> = ({
  showName,
  organization,
  trial,
  entries,
  ...
  return (
    <div className="report-page">
      <div className="report-header">
        ...
        {trialDate && <p className="report-subtitle">{trialDate}</p>}
        <p className="report-subtitle">{trialLabel} Entry Counts</p>
      </div>
      ...
      <div className="stats-footer">
        Trial Entry Total: {entries.length} &nbsp;&nbsp; People: {uniquePeople} &nbsp;&nbsp; Dogs:{' '}
        {uniqueDogs}
      </div>
    </div>
  );
