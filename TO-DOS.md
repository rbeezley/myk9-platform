...
- **Phase 2: Reusable show day components** — Extract `NextUpCard`, `ClassTimelineCard`, `ShowDayHero`, `StickyShowBar` from mobile ExhibitorDashboard patterns. Delete 671-line mock-data component. **Plan:** `docs/plans/exhibitor-dashboard-redesign.md`. **Files:** `apps/myk9show/src/components/exhibitor/`.
