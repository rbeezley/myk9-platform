...
| Produce show-level financial totals for the club.                                          | Required               | Reports Financial Report / Entry Management data      | Partially covered | Financial Report now separates entry status from payment status and prints gross, discounts, waived, collected, refunded, outstanding, net retained, payment-method, and trial breakdowns. Remaining launch gate: representative print/PDF and club reconciliation rehearsal evidence. |
