...
export const AKC_SCENT_WORK_TEMPLATE: Omit<ClassTemplate, 'id' | 'createdAt' | 'createdBy'> = {
  ...
  // Metadata
  description: 'Official AKC Scent Work template based on 2024 Judge\'s Guidelines. Generates all 27 standard classes with proper rules and field configurations.',
...
export const createCustomAKCScentWorkTemplate = (
  customizations: {
    templateName: string;
