...
describe('CredentialsHelpPage', () => {
  ...
  it('explains both credential paths', () => {
    render(<CredentialsHelpPage />);
    expect(screen.getByRole('heading', { level: 2, name: /your account/i })).toBeInTheDocument();
    expect(screen.getByRole('heading', { level: 2, name: /a show passcode/i })).toBeInTheDocument();
  });
