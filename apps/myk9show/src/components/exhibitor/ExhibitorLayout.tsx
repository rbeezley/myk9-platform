...
export const ExhibitorLayout: React.FC<ExhibitorLayoutProps> = ({ children }) => {
  ...
  return (
    <div className="flex min-h-screen bg-background">
      ...
      >
        <ExhibitorSidebar onCloseMobile={() => setSidebarOpen(false)} />
      </div>
      ...
      <div className="flex-1 md:ml-72">
        ...
        {/* Page content */}
        <main className="flex-1 overflow-auto pt-20 md:pt-8">
