 ...
 * including an RLS read that hides entries the SECURITY DEFINER guard can still
 * see — rendered as "nothing blocks this". The user got a plain, enabled
 * Delete, no override affordance, and an MK002 refusal with nowhere to go.
 *
