 ...
 */
const measurementForWrite = (value: number | null | undefined): string | null =>
 ...
 * how this file's divergences started.
 */
const emptyToNull = <T extends string>(value: T | null | undefined): T | null => value || null;

/** The status a dog is created with when the caller does not choose one. */
const DEFAULT_DOG_STATUS: DogStatus = 'active';
 ...
 *
 * Exported because the direct Supabase update (`mapDogInputToUpdate`) and the
