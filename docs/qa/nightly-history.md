...
- **Fixes made:** `apps/myk9show/src/services/database/entries/secretary.ts`, `apps/myk9show/src/components/shows/wizard/steps/OfficialPicker.tsx`, `apps/myk9show/src/test/e2e/cross-role-workflows.spec.ts`, `apps/myk9show/src/test/e2e/registration/entryCreationCore.spec.ts`, `apps/myk9show/src/test/e2e/registration/secretaryExistingUsers.spec.ts`, `apps/myk9show/src/test/e2e/secretary-entry-walk.spec.ts`, `apps/myk9show/src/test/e2e/secretary/show-wizard-officials.spec.ts`, `apps/myk9show/src/test/e2e/uat/secretary/critical-path.spec.ts`, `docs/qa/findings.md`, `docs/qa/nightly-history.md`.
...
- **Notes:** Ran from clean synced `main`, then used local branch `codex/nightly-qa-2026-05-25` before editing. Proofs passed: promoted Vitest Nightly (`18 passed`), focused repaired Playwright proof (`17/19` then remaining `1/1` after final filter adjustment), full active Playwright Nightly (`42 passed`, retries disabled), short route sweep (`24/24`). The stricter long-settle route sweep intentionally waited 9s after render and exposed the late Supabase `57014` failures recorded above. Temporary route-sweep spec was removed.
