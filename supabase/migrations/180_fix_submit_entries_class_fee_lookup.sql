-- Fix submit_show_entries: migration 179 re-introduced the classes.show_id bug
-- (originally fixed in 164). This corrects the class-fee lookup to join via
-- trial_id -> trials.show_id, and retains the handler_id fix from 179.
