...
export const pageDirectory: readonly PageEntry[] = [
  ...
  },
  {
    ...
    title: 'My Shows',
    description:
      "Exhibitor's show hub with entries, dogs, upcoming shows, and an at-show banner on the day.",
    roles: [UserRole.EXHIBITOR, UserRole.SITE_ADMIN],
    classification: 'critical-path',
    category: 'Entries',
    status: 'working',
  ...
  },
  {
    ...
    description:
      "Placeholder. features.analytics is false, so this renders a 'coming soon' screen; the planned page is exhibitor-only stats: entry counts, Qs, placements over time.",
    roles: [UserRole.EXHIBITOR, UserRole.SITE_ADMIN],
    classification: 'park',
    category: 'Entries',
    status: 'stub',
  ...
  },
  {
    ...
    category: 'Payments',
    status: 'working',
    linksTo: ['/shows', '/exhibitor/entries', '/shows/:id'],
  },
  {
