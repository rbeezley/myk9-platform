...
import { Copy, ArrowRight, Search, CheckCircle } from 'lucide-react';
...
export const ShowCloneDialog: React.FC<ShowCloneDialogProps> = ({ open, onOpenChange }) => {
  ...
  const handleCloneShow = useCallback(async () => {
    ...
    try {
      ...
      updateShowData({
        ...
        organization: selectedShow.organization as 'AKC' | 'UKC' | 'Other',
        ...
        return (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="text-muted-foreground mb-4">
              "{transformation.newName || selectedShow?.name}" has been created from the cloned
              data.
            </p>
            <p className="text-sm text-muted-foreground">
              You can now continue editing in the Show Creation Wizard or view it in your shows
              list.
            </p>
          </div>
        );
            ...
            <div className="border-t bg-background px-6 py-4">
              <div className="flex items-center justify-between">
                ...
                <div className="flex items-center gap-3">
                  ...
                  {currentStep === 'review' && (
                    <Button onClick={handleCloneShow} disabled={isCloning}>
                      {isCloning ? (
                        <>
