...
export const createMockField = (overrides: Partial<FieldSpecification> = {}): FieldSpecification => ({
  fieldName: 'testField',
...
export const createMockClassDefinition = (overrides: Partial<ClassDefinition> = {}): ClassDefinition => ({
  element: 'Container',
  level: 'Novice',
  section: 'A',
...
export const createMockTemplate = (overrides: Partial<ClassTemplate> = {}): ClassTemplate => ({
  ...
  classDefinitions: [
    ...
    createMockClassDefinition({ element: 'Buried', level: 'Advanced', className: 'Buried Advanced' })
  ],
  defaults: {
    entryFees: {
      preEntry: 25,
...
export const createAKCScentWorkTemplate = (): ClassTemplate => ({
  ...
  fieldSpecifications: [
    ...
    createMockField({ fieldName: 'timeLimit1', fieldSource: 'judge-set', dataType: 'number' }),
    createMockField({ fieldName: 'maxEntries', fieldSource: 'admin-set', dataType: 'number' }),
    createMockField({ fieldName: 'preEntryFee', fieldSource: 'admin-set', dataType: 'number', defaultValue: 25 })
  ],
  classDefinitions: [
    // Container classes
    createMockClassDefinition({ 
