...
7. **Waitlist and classes** — capacity cards, class judge display. **Registry:** compare what step 3 of the wizard OFFERED for this week's walk show (not the one or two classes the show ended up with) against that registry's own list, as seeded in `sport_class_rules` — AKC Scent Work: 26 classes over Container, Interior, Exterior, Buried, Handler Discrimination at Novice A, Novice B, Advanced, Excellent, Master, plus one level-less Detective; UKC Nosework: 50 classes over Container, Interior, Exterior, Vehicle, Handler Discrimination at Novice, Advanced, Superior, Master, Elite, each split A/B; ASCA Scent Detection: 16 classes over Container, Interior, Exterior, Vehicle at Novice, Open, Advanced, Excellent, no sections. Novice, Advanced, Master and Excellent are shared between registries, so judge by the whole list: a class whose element or level is outside this registry's list (Buried or Detective on UKC/ASCA; Superior or Elite outside UKC; Open outside ASCA; A/B sections on ASCA) is a P1.
