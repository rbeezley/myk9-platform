...
import type { ShowStats } from './AnalyticsDashboard.types';
import { mockPerformanceData, mockDogPerformance, placementData } from './AnalyticsDashboard.data';
...
export function AnalyticsDashboard() {
  ...
  const stats: ShowStats = useMemo(() => {
    const totals = mockPerformanceData.reduce(
      (acc, month) => ({
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
        ...
        <div className="flex gap-3">
          ...
          <Button
            variant="outline"
            size="sm"
            className="border-border/50 text-muted-foreground hover:text-foreground hover:border-primary/30 hover:-translate-y-0.5 transition-all duration-300 shadow-sm"
          >
            ...
            <CardContent className="relative">
              <div className="space-y-4">
                {mockDogPerformance.map((dog, index) => (
                  <div
                    key={dog.id}
                    className="group/dog relative overflow-hidden p-6 border border-border/50 bg-gradient-to-br from-muted/30 to-muted/10 rounded-2xl transition-all duration-500 hover:shadow-lg hover:-translate-y-1"
                  >
                    ...
                    <div className="relative flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="font-semibold text-lg group-hover/dog:text-primary transition-colors duration-300">
                            {dog.name}
                          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Card className="group relative overflow-hidden bg-gradient-to-br from-card to-card/80 border border-border rounded-2xl shadow-sm backdrop-blur-xl transition-all duration-500 hover:shadow-xl hover:-translate-y-2">
              ...
              <CardContent className="relative p-8 text-center">
                ...
                <p className="text-3xl font-bold text-green-600 group-hover:text-green-500 transition-colors duration-300">
                  ${stats.totalEarnings.toLocaleString()}
                </p>
                <p className="text-sm text-muted-foreground uppercase tracking-wide mt-2">
                  Total Earnings
                </p>
              </CardContent>
            </Card>
            <Card className="group relative overflow-hidden bg-gradient-to-br from-card to-card/80 border border-border rounded-2xl shadow-sm backdrop-blur-xl transition-all duration-500 hover:shadow-xl hover:-translate-y-2">
              ...
              <CardContent className="relative p-8 text-center">
                ...
                <p className="text-3xl font-bold text-red-600 group-hover:text-red-500 transition-colors duration-300">
