...
## Purpose
Support tickets provide the durable operator handoff behind the in-app help
front door. Tickets carry diagnostic context, threaded replies, notifications,
priority signals, and access control so support can work inside myK9Show.
