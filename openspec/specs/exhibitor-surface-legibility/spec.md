# exhibitor-surface-legibility Specification

## Purpose

Keep exhibitor navigation, records, controls, tables, and schedules legible and accessible at every supported width.
