...
interface TabsProps<T extends string = string> extends Omit<
...
const Tabs = React.forwardRef<React.ElementRef<typeof TabsPrimitive.Root>, TabsProps<any>>(
  ({ onValueChange, ...props }, ref) => {
    ...
    return <TabsPrimitive.Root ref={ref} {...baseUIProps} {...props} />;
  }
);
...
const TabsTrigger = React.forwardRef<React.ElementRef<typeof TabsPrimitive.Tab>, TabsTriggerProps>(
