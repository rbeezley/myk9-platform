...
export function getCoreWebVitalsCards(performanceData: PerformanceData | null): MetricCard[] {
...
export function getCustomMetricsCards(performanceData: PerformanceData | null): MetricCard[] {
