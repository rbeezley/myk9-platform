-- =============================================================================
-- Migration 20260619133000: add reveal fields to own-entry results view
--
-- My Entries needs the cascade-aware release marker and dog image URL on the
-- same row shape as view_public_entry_results. Keep the existing security
-- model: security_invoker=true means entries RLS still restricts rows to the
-- signed-in exhibitor's own entries.
-- =============================================================================
