...
asked _"did this ship?"_ per-doc; this pass cross-references each plan against the **code, merged
...
**Method:** 10 thematic cluster agents (so supersession _within_ a cluster is visible) + 1 light
...
- **24 stay genuinely live** — split between _open work_ (11) and _living trackers/registries_ (13).
