/**
 * AKC Scent Work Entry Scoresheet (Secretary View)
 *
...
export const AKCScentWorkEntryScoresheet: React.FC<EntryScoresheetProps> = ({
  entry,
  classInfo,
  rules,
  onSubmit,
...
registerScoresheet('AKC_SCENT_WORK', 'entry', AKCScentWorkEntryScoresheet);
