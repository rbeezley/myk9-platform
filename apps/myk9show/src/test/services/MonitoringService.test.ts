...
const monitoringServiceInternals = fromAny<
  { instance: MonitoringService | undefined },
...
describe('MonitoringService', () => {
  ...
  beforeEach(() => {
    ...
    mockPerformanceObserver.mockImplementation(function (this: Record<string, unknown>) {
    ...
    // Reset singleton
    monitoringServiceInternals.instance = undefined;
  ...
  describe('Performance Monitoring', () => {
    ...
    it('should handle component render errors', () => {
      ...
      expect(() => monitoring.measureComponentRender('FailedComponent', mockComponent)).toThrow(
        'Render failed'
      );
  ...
  describe('Performance Observer Setup', () => {
    it('should setup performance observers if available', () => {
      ...
      mockPerformanceObserver.mockImplementation(function (
        this: {
  ...
  describe('Cleanup', () => {
    it('should destroy monitoring service', () => {
      ...
      fromAny<{ performanceMonitor: { observers: unknown[] } }, MonitoringService>(
        monitoring
      ).performanceMonitor.observers = [mockObserver];
  ...
  describe('Edge Cases', () => {
    ...
    it('should handle performance timing edge cases', async () => {
      ...
      const result = await monitoring.measureResourceTiming('zero-duration', () =>
