...
| P1 | TODO triage / judge flow | `/judge/check-in` has hardcoded empty ring assignments. | Routed page can show false empty state. | Wire real query or add launch-blocking backlog item. | Phase-2 confirmed; see `09-phase-2-verification.md`. |
...
| P2 | Duplication | Magazine/Gazette email renderers duplicate transactional helper/data contracts. | Deno builders and React templates duplicate escaping, run tables, CTA/contact/signoff patterns. | Extract shared helpers/data type and add preview-vs-production sync tests. | Phase-2 confirmed; see `09-phase-2-verification.md`. |
