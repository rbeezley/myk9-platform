    ...
    return await page.evaluate(() => {
      return new Promise((resolve) => {
        ...
        const fidObserver = new PerformanceObserver((entryList) => {
          ...
          vitals.fid = (firstInput as PerformanceEventTiming).processingStart - firstInput.startTime;
        });
...
test.describe('Performance Tests', () => {
  ...
  test.describe('Page Load Performance', () => {
    ...
    test('my entries page loads within budget', async ({ page }) => {
      const loadTime = await PerformanceUtils.measurePageLoad(page, `${BASE_URL}/my-entries`);
      
      expect(loadTime).toBeLessThan(PERFORMANCE_BUDGETS.pageLoad);
      console.log(`My entries load time: ${loadTime}ms`);
    });
    ...
    test('secretary dashboard loads within budget', async ({ page }) => {
      const loadTime = await PerformanceUtils.measurePageLoad(page, `${BASE_URL}/secretary/dashboard`);
  ...
  test.describe('Resource Loading', () => {
    test('critical resources load efficiently', async ({ page }) => {
      ...
      const criticalSlowResources = slowResources.filter(r => 
...
test.describe('Stress Tests', () => {
  ...
  test('search handles rapid typing', async ({ page }) => {
    ...
    const searchTerms = [
      'a', 'ag', 'agi', 'agil', 'agili', 'agilit', 'agility',
      'agility ', 'agility c', 'agility ch', 'agility cha',
      'agility cham', 'agility champ', 'agility champi',
      'agility champio', 'agility champion'
    ];
