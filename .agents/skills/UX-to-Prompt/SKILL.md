---
name: UX-to-Prompt
description: Use when translating UX specifications into build-order prompts for UI generation tools. Triggers when user has a UX spec, PRD, or detailed feature doc and needs sequential, self-contained prompts for tools like v0, Bolt, or Codex frontend-design.
---
...
- Output needs to feed into UI generation tools (v0, Bolt, Codex, etc.)
