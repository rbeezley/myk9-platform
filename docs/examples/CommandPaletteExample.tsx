        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <ul className="list-disc list-inside space-y-1 text-sm text-gray-600">
                <li>
                  <strong>Exhibitors:</strong> See only their own dogs and basic navigation
                </li>
                <li>
                  <strong>Secretaries:</strong> Access all dogs, people creation, show management
                </li>
                <li>
                  <strong>Club Admins:</strong> Full club management capabilities
                </li>
                <li>
                  <strong>Site Admins:</strong> System administration access
                </li>
              </ul>
            </div>
          </div>
