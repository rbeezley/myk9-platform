...
const packetData: Omit<EmergencyPacketInput, 'generatedAt'> = {
  ...
  classes: [
    { id: 'c1', trialId: 't1', name: 'Interior', element: 'Interior', level: 'Novice', section: null, classNumber: null, displayOrder: 0, judgeName: 'J', ringLabel: null, startTime: null, timeLimitSeconds: 180, timeLimitArea2Seconds: null, timeLimitArea3Seconds: null, numAreas: 1 },
    { id: 'c2', trialId: 't2', name: 'Interior', element: 'Interior', level: 'Novice', section: null, classNumber: null, displayOrder: 0, judgeName: 'J', ringLabel: null, startTime: null, timeLimitSeconds: 180, timeLimitArea2Seconds: null, timeLimitArea3Seconds: null, numAreas: 1 },
  ],
  entries: [
    { id: 'e1', armband: 1, runOrder: 1, callName: 'A', breed: 'BC', handler: 'H', registrationNumber: null, section: null, classId: 'c1', trialId: 't1' },
    { id: 'e2', armband: 2, runOrder: 1, callName: 'B', breed: 'BC', handler: 'H', registrationNumber: null, section: null, classId: 'c2', trialId: 't2' },
  ],
};
