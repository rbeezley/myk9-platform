  ...
  return (
    <EntryReceipt
      ...
      entry={{
        ...
        // differed from what the same order showed online. An order whose
        // confirmation number has not replicated yet prints nothing, which is
        // the behaviour MYK9-631 Q7 pinned.
