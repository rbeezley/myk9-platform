...
interface AddRegistrationDialogProps {
  open: boolean;
  onClose: () => void;
  onAdd: (newRegistration: Omit<Registration, 'id'>) => void;
  newRegistration: Omit<Registration, 'id'>;
  setNewRegistration: (reg: Omit<Registration, 'id'>) => void;
}

const AddRegistrationDialog: React.FC<AddRegistrationDialogProps> = ({
  open,
  onClose,
  onAdd,
  newRegistration,
    ...
    <Dialog open={open} onOpenChange={onClose}>
      ...
      <DialogContent className="dialog-content max-w-2xl max-h-[90vh] flex flex-col">
        ...
        <div className="dialog-header flex-shrink-0">
          <h2 className="dialog-title">Add New Registration</h2>
          <p className="dialog-description">
            Create a new registration record for your dog.
          </p>
        </div>
