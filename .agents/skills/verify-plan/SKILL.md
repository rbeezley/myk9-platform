...
### Step 6: Add Risk Tags

Every patched or verified implementation plan must include a short validation metadata block. Add it if missing:
...
This validation profile controls how much local testing is expected before PR. CI still provides broad verification after push.
