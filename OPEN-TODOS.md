...
- [ ] **Wave D — replication-bypass reroutes + targeted test additions** — Secretary status/bulk status writes, secretary Entry Management reads, and armband read/write reroutes are implemented; remaining slices: day-of scratch/move-up reads, secretary check-in report adapter, and exhibitor show-day data adapter.
