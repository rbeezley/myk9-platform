...
interface BlockedDogDeleteDialogProps {
  /** Dogs the server refused over paid/scored entries. Empty closes the dialog. */
  dogs: Dog[];
  open: boolean;
  onClose: () => void;
...
export function BlockedDogDeleteDialog({
  ...
  return (
    <DeleteConfirmationDialog
      ...
      description="These dogs have paid or scored entries, so the server refused to delete them."
