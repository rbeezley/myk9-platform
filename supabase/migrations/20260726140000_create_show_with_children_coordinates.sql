-- Extend create_show_with_children to persist venue coordinates
-- (openspec change: add-show-map-view). Identical to 20260510143000 except
-- the shows INSERT now carries latitude/longitude from the wizard payload.
