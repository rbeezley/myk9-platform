...
- `docs/archive/superpowers/specs/2026-06-14-ux-journey-synthesis-design.md` - approved synthesis design.
...
- Read: `docs/archive/superpowers/specs/2026-06-14-ux-journey-synthesis-design.md`
...
```bash
for file in \
  docs/archive/superpowers/specs/2026-06-14-ux-journey-synthesis-design.md \
...
```bash
git add docs/audits/2026-06-ux-journeys/SUMMARY.md docs/archive/superpowers/plans/2026-06-14-ux-journey-synthesis.md
```
