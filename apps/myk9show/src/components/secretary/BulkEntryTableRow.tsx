...
import type { BulkEntryData } from './bulk-result-entry-utils';

interface BulkEntryTableRowProps {
  item: BulkEntryData;
  index: number;
...
export const BulkEntryTableRow = React.memo(function BulkEntryTableRow({
  item,
  index,
  validationError,
  onFieldChange,
  onKeyDown,
}: BulkEntryTableRowProps) {
  return (
    <TableRow
      className={cn(
