...
| Submit electronic registry results and preserve the artifacts needed for the club.                                | Required   | Submit Results route; manual email for AKC XML               | Partially covered | AKC path documented. UKC/ASCA submission paths need registry-specific confirmation.                                                                                                                                                                                                                                                    |
