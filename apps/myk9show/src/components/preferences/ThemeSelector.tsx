...
const themeOptions: Array<{ value: ThemeMode; label: string; icon: React.ComponentType<{ className?: string }>; description: string }> = [
...
const fontSizeOptions: Array<{ value: FontSizeScale; label: string; description: string; scale: string }> = [
...
export function ThemeSelector({ preferences, onUpdate, onReset }: ThemeSelectorProps) {
   ...
   */
  const handleAccessibilityChange = (setting: 'reduceMotion' | 'highContrast', enabled: boolean) => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-semibold tracking-tight mb-2">Theme & Appearance</h3>
        <p className="text-sm text-muted-foreground">
          Customize the visual appearance and layout to match your preferences
        </p>
      </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Select an accent color for the interface
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Preview how your theme settings will look
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="border rounded-lg p-4 bg-background">
            <div className="space-y-3">
              ...
              <p className="text-sm text-muted-foreground">
                ...
                The layout density and font size will affect the spacing and readability.
              </p>
