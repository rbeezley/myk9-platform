-- =====================================================
-- Migration 022: Fix up_soon trigger authorization
-- =====================================================
-- Problem: notify_up_soon() uses broken JWT authorization from Migration 019
-- Solution: Use hardcoded anon key like Migration 021 fixed for announcements
-- =====================================================
