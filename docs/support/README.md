...
> **Something's wrong right now?** Start at [`../operations/START-HERE.md`](../operations/START-HERE.md) —
> the symptom-first router that funnels both operator incidents and user-support issues to the right doc.
