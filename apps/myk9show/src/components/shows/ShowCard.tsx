...
export const ShowCard: React.FC<ShowCardProps> = ({
  ...
  return (
    <Card className={`group relative overflow-hidden bg-gradient-to-br from-card to-card/80 border border-border rounded-2xl shadow-sm backdrop-blur-xl transition-all duration-500 hover:shadow-xl hover:-translate-y-2 ${className}`}>
      ...
      <CardContent className="relative">
        <Button 
          ...
          className="w-full mt-2 bg-gradient-to-r from-primary to-secondary text-primary-foreground hover:shadow-xl hover:-translate-y-1 hover:scale-105 transition-all duration-300"
        >
          View Details
        </Button>
      </CardContent>
