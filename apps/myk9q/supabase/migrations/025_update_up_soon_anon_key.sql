-- =====================================================
-- Migration 025: Update anon key in up_soon trigger
-- =====================================================
-- Problem: Trigger uses outdated anon key causing 401 Invalid JWT errors
-- Solution: Update to current anon key
-- =====================================================
