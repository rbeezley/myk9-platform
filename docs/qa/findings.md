...
- **2026-06-04 update — DID NOT REPRODUCE.** The public route sweep completed cleanly and measured `/` at 375px with `overflow=0`. Because this finding reproduced identically on 2026-05-30 and 2026-06-02, keep it open until a focused `/` mobile overflow replay confirms whether the layout changed or the temporary route-health measurement varied.
