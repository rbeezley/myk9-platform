...
4. Test the public replicated-table read/subscription boundary with fake IndexedDB and controlled time/network. Keep existing sync/error/dirty-row coverage. The public seam approval is requested before new tests; inventory and pure deletions can proceed independently.
